#!/usr/bin/env python3
# This file is part of the sale_subscription_total_discount module for Tryton.
...
download_url = 'https://github.com/tryton-ar/sale_subscription_total_discount/tree/%s' % branch
