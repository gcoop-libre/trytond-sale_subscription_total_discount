Sale Subscription Total Discount Module
========================================

The sale_subscription_total_discount module of the Tryton application platform.
...
questions on the module bug tracker:
  ...
  https://github.com/gcoop-libre/trytond-sale_subscription_total_discount/issues
